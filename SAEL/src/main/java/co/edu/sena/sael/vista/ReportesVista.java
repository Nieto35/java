...
public class ReportesVista {
    ...
    public void generarReporteFelicitacion() {
        try {
            ...
            System.out.println("el dcumento del aprendiz es: "+aprendiz.getDocumentoaprendiz());
            ...
            String params
                    = "'"
                    + url + "/faces/ReporteFelicitaciones.do?DocumentoAprendiz="+aprendiz.getDocumentoaprendiz()
                    + "','reportWindow'";
